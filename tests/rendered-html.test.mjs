...
assert.match(peopleHtml, /Ph\.D\. @ UIUC/);
  ...
  assert.ok(publicationsHtml.indexOf("2026-cikm-spectral-decoupling") < publicationsHtml.indexOf("2026-cikm-keir-compact-sparse-spaces"));
  assert.ok(publicationsHtml.indexOf("2026-cikm-keir-compact-sparse-spaces") < publicationsHtml.indexOf("2026-cikm-tracer"));
...
test("restores the complete news archive and related links", async () => {
  ...
  assert.ok(html.indexOf("2026-cikm-spectral-decoupling") < html.indexOf("2026-cikm-keir-compact-sparse-spaces"));
  assert.ok(html.indexOf("2026-cikm-keir-compact-sparse-spaces") < html.indexOf("2026-cikm-tracer"));
