...
const publicationRecords: Omit<Publication, "topics">[] = [
  ...
  { id:"2026-cikm-keir-compact-sparse-spaces", year:2026, order:3, venue:`${V.CIKM}, KEIR Workshop, Oral`, title:"Concepts Complement Dense Semantics: Learning Compact Sparse Spaces for Text-Image Retrieval", authors:"Yoonseo Kim*, Jungwoo Choi*, Cheonyoung Park, Youngwook Kim, Yongho Song, SeongKu Kang", summary:"We learn compact sparse concept spaces that complement dense semantics for text-image retrieval.", thumbnail:image("2026", "2026-cikm-keir-compact-sparse-spaces") },
  { id:"2026-cikm-environment-conditioned", year:2026, order:4, venue:V.CIKM, title:"Beyond Observed Auxiliary Relations: Environment-Conditioned Modeling for Multi-Behavior Recommendation", authors:"Seunghan Lee, Hyunsik Yoo, Jian Kang, Susik Yoon, SeongKu Kang", summary:"We refine unreliable auxiliary signals via environment-conditioned modeling.", thumbnail:image("2026", "2026-cikm-environment-conditioned", "jpg"), link:"https://arxiv.org/pdf/2608.22920" },
  { id:"2026-cikm-scord", year:2026, order:5, venue:V.CIKM, title:"SCoRD: Semantic-Assisted Continual Retriever-Reranker Distillation for LLM-Based Recommendation", authors:"Seunghyun Baek*, Gyuseok Lee*, Seunghan Lee, Wonbin Kweon, Dong Wang, SeongKu Kang", summary:"We propose a continual update framework for retriever-reranker pipelines.", thumbnail:image("2026", "2026-cikm-scord"), link:"https://arxiv.org/pdf/2608.19998" },
  { id:"2026-cikm-item-profiles", year:2026, order:6, venue:V.CIKM, title:"Profiling What Matters: Context-Aware Item Profiles from Large-Scale Metadata for LLM Recommenders", authors:"Dojun Hwang, Seunghan Lee, Cheonyoung Park, Sara Yu, SeongKu Kang", summary:"We structure vast item knowledge and selectively feed item information into LLM rerankers.", thumbnail:image("2026", "2026-cikm-item-profiles"), link:"https://arxiv.org/pdf/2608.20801" },
  { id:"2026-cikm-spectral-decoupling", year:2026, order:7, venue:V.CIKM, title:"Dynamic Spectral Decoupling for Time-Series Forecasting", authors:"Jaehyung Lee, Seungha Hong, Seongje Lee, Suyeon Kim, SeongKu Kang†, Hwanjo Yu†", summary:"We separate frequency components based on instance-wise energy concentration.", thumbnail:image("2026", "2026-cikm-spectral-decoupling"), link:"https://idealab-ku.github.io/idealab-website/media/publications/2026/papers/2026-cikm-spectral-decoupling.pdf" },
  { id:"2026-cikm-tracer", year:2026, order:8, venue:V.CIKM, title:"TRACER: Balancing Stability-Plasticity-Cognitivity Trilemma for LLM Enhanced Continual Recommendation", authors:"Woojoo Kim, Hyunsik Yoo, Junyoung Kim, Jaehyung Lim, SeongKu Kang†, Hwanjo Yu†", summary:"We identify the stability-plasticity-cognitivity trilemma of LLM rankers.", thumbnail:image("2026", "2026-cikm-tracer"), link:"https://arxiv.org/pdf/2608.16075" },
  { id:"2026-colm-reward-factorization", year:2026, order:9, venue:V.COLM, title:"Uncertainty-Aware Variational Reward Factorization via Probabilistic Preference Bases for LLM Personalization", authors:"Gyuseok Lee, Wonbin Kweon, Zhenrui Yue, SeongKu Kang, Jiawei Han, Dong Wang", summary:"We represent user preference as a variational distribution.", thumbnail:image("2026", "2026-colm-reward-factorization"), link:"https://arxiv.org/pdf/2604.00997" },
  { id:"2026-tist-academic-concept-index", year:2026, order:10, venue:V.TIST, title:"Improving Scientific Document Retrieval with Academic Concept Index", authors:"Jeyun Lee*, Junhyoung Lee*, Wonbin Kweon, Bowen Jin, Yu Zhang, Susik Yoon, Dongha Lee, Hwanjo Yu, Jiawei Han, SeongKu Kang", summary:"We introduce a concept index: structured knowledge of scientific concepts for retrieval.", thumbnail:image("2026", "2026-tist-academic-concept-index"), link:"https://arxiv.org/pdf/2601.00567" },
  { id:"2026-kdd-corank", year:2026, order:11, venue:V.KDD, title:"CoRank: LLM-Based Compact Reranking with Document Features for Scientific Retrieval", authors:"Runchu Tian, Xueqiang Xu, Bowen Jin, SeongKu Kang, Jiawei Han", summary:"We propose a training-free, model-agnostic reranking framework for scientific retrieval.", thumbnail:image("2026", "2026-kdd-corank"), link:"https://arxiv.org/pdf/2505.13757" },
  { id:"2026-sigir-sprint", year:2026, order:12, venue:V.SIGIR, title:"SPRINT: Scalable and Predictive Intent Refinement for LLM-Enhanced Session-based Recommendation", authors:"Gyuseok Lee, Wonbin Kweon, Zhenrui Yue, Yaokun Liu, Yifan Liu, Susik Yoon, Dong Wang, SeongKu Kang", summary:"We propose a scalable framework that infers and incorporates reliable user intents.", thumbnail:image("2026", "2026-sigir-sprint"), link:"https://arxiv.org/pdf/2508.00570" },
  { id:"2026-sigir-filling-gaps", year:2026, order:13, venue:V.SIGIR, title:"Filling the Gaps: Selective Knowledge Augmentation for LLM Recommenders", authors:"Jaehyun Lee, Sanghwan Jang, SeongKu Kang†, Hwanjo Yu†", summary:"We estimate an LLM's internal knowledge and selectively inject additional information.", thumbnail:image("2026", "2026-sigir-filling-gaps"), link:"https://arxiv.org/pdf/2604.07825" },
  { id:"2026-sigir-flame", year:2026, order:14, venue:V.SIGIR, title:"FLAME: Condensing Ensemble Diversity into a Single Network for Efficient Sequential Recommendation", authors:"WooJoo Kim, Junyoung Kim, Jaehyung Lim, Seong Jin Choi, SeongKu Kang†, Hwanjo Yu†", summary:"We condense ensemble-level diversity into a single recommendation model.", thumbnail:image("2026", "2026-sigir-flame"), link:"https://arxiv.org/pdf/2604.04038" },
  { id:"2026-sigir-mviger", year:2026, order:15, venue:V.SIGIR, title:"MVIGER: Multi-View Variational Integration of Complementary Knowledge for Generative Recommender", authors:"Tongyoung Kim, Soojin Yoon, SeongKu Kang, Jinyoung Yeo, Dongha Lee", summary:"We integrate prompt-template and index combinations with a unified variational framework.", thumbnail:image("2026", "2026-sigir-mviger"), link:"https://arxiv.org/pdf/2408.08686" },
  { id:"2026-acl-explainable-retrieval", year:2026, order:16, venue:`${V.ACL}, Findings`, title:"Why These Documents? Explainable Generative Retrieval with Hierarchical Category Paths", authors:"Sangam Lee, Ryang Heo, SeongKu Kang, Susik Yoon, Jinyoung Yeo, Dongha Lee", summary:"We use hierarchical category paths as explanations for generative retrieval.", thumbnail:image("2026", "2026-acl-explainable-retrieval"), link:"https://arxiv.org/pdf/2411.05572" },
  { id:"2026-iclr-continual-lora", year:2026, order:17, venue:V.ICLR, title:"Continual Low-Rank Adapters for LLM-based Generative Recommender Systems", authors:"Hyunsik Yoo, Ting-Wei Li, SeongKu Kang, Zhining Liu, Charlie Xu, Qilin Qi, Hanghang Tong", summary:"We continuously adapt LoRA for recommendation.", thumbnail:image("2026", "2026-iclr-continual-lora"), link:"https://arxiv.org/pdf/2510.25093" },
  { id:"2026-dasfaa-tutorial", year:2026, order:18, venue:`${V.DASFAA}, Tutorial`, title:"Continual Recommender Systems: A Focus on LLMs and Evolving Trends", authors:"Seunghan Lee, Seunghyun Baek, Dojun Hwang, Hyunsik Yoo, SeongKu Kang", summary:"We present a tutorial on continual learning with a focus on LLMs.", thumbnail:image("2026", "2026-dasfaa-tutorial"), page:"/research/dasfaa26-tutorial-continual-recommender-systems" },
  { id:"2026-wsdm-data-streams", year:2026, order:19, venue:V.WSDM, title:"Capturing User Interests from Data Streams for Continual Sequential Recommendation", authors:"Gyuseok Lee, Hyunsik Yoo, Junyoung Hwang, SeongKu Kang†, Hwanjo Yu", summary:"We propose CSTRec, which continuously updates a transformer-based sequential recommender.", thumbnail:image("2026", "2026-wsdm-data-streams"), link:"https://arxiv.org/pdf/2506.07466" },
  { id:"2026-www-pairsem", year:2026, order:20, venue:V.WWW, title:"PairSem: LLM-Guided Pairwise Semantic Matching for Scientific Document Retrieval", authors:"Wonbin Kweon, Runchu Tian, SeongKu Kang, Pengcheng Jiang, Zhiyong Lu, Jiawei Han, Hwanjo Yu", summary:"We match scientific document semantics using entity-aspect pairs.", thumbnail:image("2026", "2026-www-pairsem"), link:"https://arxiv.org/pdf/2510.09897" },
  { id:"2026-kdd-cream", year:2026, order:21, venue:V.KDD, title:"CREAM: Continual Retrieval on Dynamic Streaming Corpora with Adaptive Soft Memory", authors:"HuiJeong Son, Hyeongu Kang, Sunho Kim, Subeen Ho, SeongKu Kang, Dongha Lee, Susik Yoon", summary:"We retrieve from streaming corpora with adaptive memory.", thumbnail:image("2026", "2026-kdd-cream"), link:"https://arxiv.org/pdf/2601.02708" },
  { id:"2026-tkde-bpl", year:2026, order:22, venue:V.TKDE, title:"BPL: Bias-adaptive Preference Distillation Learning for Recommender System", authors:"SeongKu Kang, Jianxun Lian, Dongha Lee, Wonbin Kweon, Sanghwan Jang, Jaehyun Lee, Jindong Wang, Xing Xie, Hwanjo Yu", summary:"We learn user preferences with bias-adaptive distillation.", thumbnail:image("2026", "2026-tkde-bpl"), link:"https://arxiv.org/pdf/2510.16076" },
...
const publicationTopicsById: Record<string, PublicationTopic[]> = {
  ...
  "2026-cikm-keir-compact-sparse-spaces": t("search-retrieval"),
