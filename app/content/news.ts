...
export const newsItems: NewsItem[] = [
  ...
  paper("2026-colm-reward-factorization", 2026, 8, "COLM", "Uncertainty-Aware Variational Reward Factorization via Probabilistic Preference Bases for LLM Personalization"),
  paper("2026-tist-academic-concept-index", 2026, 9, "TIST", "Improving Scientific Document Retrieval with Academic Concept Index"),
  { id:"2026-seoktop-big-data", year:2026, order:10, category:"Award", title:"Prof. Kang received the Seoktop Lecture Award (Big Data Analytics) from Korea University.", href:"/people/pi" },
  paper("2026-kdd-corank", 2026, 11, "KDD", "CoRank: LLM-Based Compact Reranking with Document Features for Scientific Retrieval"),
  { id:"2026-data-intelligence-talk", year:2026, order:12, category:"Talk", title:"Invited talk: “Knowledge-Structured Retrieval for Scientific Literature”, Data Intelligence Workshop, 2026." },
  paper("2026-sigir-sprint", 2026, 13, "SIGIR", "SPRINT: Scalable and Predictive Intent Refinement for LLM-Enhanced Session-based Recommendation"),
  ...
  paper("2026-wsdm-data-streams", 2026, 21, "WSDM", "Capturing User Interests from Data Streams for Continual Sequential Recommendation"),
  paper("2026-www-pairsem", 2026, 22, "WWW", "PairSem: LLM-Guided Pairwise Semantic Matching for Scientific Retrieval"),
  paper("2026-kdd-cream", 2026, 23, "KDD", "CREAM: Continual Retrieval on Dynamic Streaming Corpora with Adaptive Soft Memory"),
  paper("2026-tkde-bpl", 2026, 24, "TKDE", "BPL: Bias-adaptive Preference Distillation Learning for Recommender System"),
  { id:"2026-professional-service", year:2026, order:25, category:"Service", title:"Prof. Kang was invited as an Area Chair of KDD and the EMNLP System Demonstration Track, and to program committees including AAAI, SIGIR, NeurIPS, CIKM, ICDM, SIGIR-AP, and ACM AI Summit.", href:"/people/pi" },
