...
export const newsItems: NewsItem[] = [
  ...
  paper("2026-cikm-spectral-decoupling", 2026, 6, "CIKM", "Dynamic Spectral Decoupling for Time-Series Forecasting"),
  paper("2026-cikm-keir-compact-sparse-spaces", 2026, 7, "CIKM", "Concepts Complement Dense Semantics: Learning Compact Sparse Spaces for Text-Image Retrieval", "CIKM 2026 Workshop"),
  paper("2026-cikm-tracer", 2026, 8, "CIKM", "TRACER: Balancing Stability-Plasticity-Cognitivity Trilemma for LLM Enhanced Continual Recommendation"),
  paper("2026-colm-reward-factorization", 2026, 9, "COLM", "Uncertainty-Aware Variational Reward Factorization via Probabilistic Preference Bases for LLM Personalization"),
  paper("2026-tist-academic-concept-index", 2026, 10, "TIST", "Improving Scientific Document Retrieval with Academic Concept Index"),
  { id:"2026-seoktop-big-data", year:2026, order:11, category:"Award", title:"Prof. Kang received the Seoktop Lecture Award (Big Data Analytics) from Korea University.", href:"/people/pi" },
  paper("2026-kdd-corank", 2026, 12, "KDD", "CoRank: LLM-Based Compact Reranking with Document Features for Scientific Retrieval"),
  { id:"2026-data-intelligence-talk", year:2026, order:13, category:"Talk", title:"Invited talk: “Knowledge-Structured Retrieval for Scientific Literature”, Data Intelligence Workshop, 2026." },
  paper("2026-sigir-sprint", 2026, 14, "SIGIR", "SPRINT: Scalable and Predictive Intent Refinement for LLM-Enhanced Session-based Recommendation"),
  paper("2026-sigir-filling-gaps", 2026, 15, "SIGIR", "Filling the Gaps: Selective Knowledge Augmentation for LLM Recommenders"),
  paper("2026-sigir-flame", 2026, 16, "SIGIR", "FLAME: Condensing Ensemble Diversity into a Single Network for Efficient Sequential Recommendation"),
  paper("2026-sigir-mviger", 2026, 17, "SIGIR", "MVIGER: Multi-View Variational Integration of Complementary Knowledge for Generative Recommender"),
  paper("2026-acl-explainable-retrieval", 2026, 18, "ACL", "Why These Documents? Explainable Generative Retrieval with Hierarchical Category Paths", "ACL 2026 Findings"),
  { id:"2026-postech-talk", year:2026, order:19, category:"Talk", title:"Invited talk: “Knowledge-Structured Retrieval for Scientific Literature”, CSE/GSAI Seminar, POSTECH, 2026." },
  paper("2026-iclr-continual-lora", 2026, 20, "ICLR", "Continual Low-Rank Adapters for LLM-based Generative Recommender Systems"),
  { id:"2026-dasfaa-tutorial", year:2026, order:21, category:"Tutorial", venue:"DASFAA", title:"Continual Recommender Systems: A Focus on LLMs and Evolving Trends", image:"/media/publications/2026/2026-dasfaa-tutorial.png", href:"/research/dasfaa26-tutorial-continual-recommender-systems" },
  paper("2026-wsdm-data-streams", 2026, 22, "WSDM", "Capturing User Interests from Data Streams for Continual Sequential Recommendation"),
  paper("2026-www-pairsem", 2026, 23, "WWW", "PairSem: LLM-Guided Pairwise Semantic Matching for Scientific Retrieval"),
  paper("2026-kdd-cream", 2026, 24, "KDD", "CREAM: Continual Retrieval on Dynamic Streaming Corpora with Adaptive Soft Memory"),
  paper("2026-tkde-bpl", 2026, 25, "TKDE", "BPL: Bias-adaptive Preference Distillation Learning for Recommender System"),
  { id:"2026-professional-service", year:2026, order:26, category:"Service", title:"Prof. Kang was invited as an Area Chair of KDD and the EMNLP System Demonstration Track, and to program committees including AAAI, SIGIR, NeurIPS, CIKM, ICDM, SIGIR-AP, and ACM AI Summit.", href:"/people/pi" },
