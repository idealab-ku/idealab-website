...
export const newsItems: NewsItem[] = [
  ...
  paper("2026-cikm-tracer", 2026, 7, "CIKM", "TRACER: Balancing Stability-Plasticity-Cognitivity Trilemma for LLM Enhanced Continual Recommendation"),
  paper("2026-cikm-keir-compact-sparse-spaces", 2026, 8, "CIKM", "Concepts Complement Dense Semantics: Learning Compact Sparse Spaces for Text-Image Retrieval", "CIKM 2026 Workshop"),
