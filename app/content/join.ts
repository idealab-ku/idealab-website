...
export const faqItems: FaqItem[] = [
  {
    ...
    content: [
      ...
      { type: "paragraph", text: "We target top venues in related fields, including Data Mining (KDD, WWW, CIKM), Information Retrieval (SIGIR, WSDM), Natural Language Processing (ACL, EMNLP, NAACL, COLM), Artificial Intelligence / Machine Learning (NeurIPS, ICML, AAAI, ICLR), and relevant high-ranking journals." },
